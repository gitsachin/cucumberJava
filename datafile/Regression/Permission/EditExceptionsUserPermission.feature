Feature: Verification of Edit Exceptions user

@EditExceptions_User_001
Scenario: Edit Exceptions User - Verifying Employee creation
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter "EditExceptionsuser@findd.io" in the User Email
...
@EditExceptions_User_002 @EditExceptions_Group01
Scenario: Edit Exceptions User - Verifying Adding Timecard entry
...
@EditExceptions_User_003 @EditExceptions_Group01
Scenario: Edit Exceptions User - Verifying Approve Timecard
...
@EditExceptions_User_007 @EditExceptions_Group01
Scenario: Edit Exceptions User - Verifying Add Device is not allowed
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
	When I click the first employee
...
@EditExceptions_User_007 @EditExceptions_Group01
Scenario: Edit Exceptions User - Verifying Account Menu is not visible
	When I click on setting option
	Then "Account Menu" should not displayed in "Employee" Page
	
@EditExceptions_User_011 @EditExceptions_Group01
Scenario: Verify that an Adding Timecard is not allowed for an employee with Edit Exceptions Permission in Timecard Page
...
@EditExceptions_User_012 @EditExceptions_Group01
Scenario: Verify that an editing an existing Timecard is not allowed for an employee with Edit Exceptions Permission in Timecard Page
	When I click on "Not Approved" in the Timecards Page
	Then I wait for 5 seconds
	Then "Overtime Hours" should displayed
	And I click on "First Name" button in the Timecards Page	
	...
	@EditExceptions_User_013 @EditExceptions_Group01
Scenario: Verify that a deleting Timecard is not allowed for an employee with Edit Exceptions Permission in Timecard Page
	When I click on "Not Approved" in the Timecards Page
	Then I wait for 5 seconds
	Then "Overtime Hours" should displayed
	And I click on "First Name" button in the Timecards Page	
...
@EditExceptions_User_010 @EditExceptions_Group01
Scenario: Edit Exceptions User - Approve button should not visible in Timecards Page
	When I click on Timecards Menu in Homepage	
	Then Timecards page should displayed
	When I click on "Not Approved" in the Timecards Page
...
@EditExceptions_User_005 @EditExceptions_Group01
Scenario: Edit Exceptions User - Verifying Deleting Timecard entry	
	When I wait for 2 seconds
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
	When I Enter the recently used employee in the search box
...
@EditExceptions_User_004 @EditExceptions_Group01
Scenario: Edit Exceptions User - Verifying Employee Status Change
	When I wait for 2 seconds
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
	When I Enter the recently used employee in the search box
...
@EditExceptions_User_006
Scenario: Edit Exceptions User - Verifying Unlock Timecard
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter Automation UserId in the User Email
	And I Enter Automation Password in the User Password
	...
	@EditExceptions_User_007
Scenario: Edit Exceptions User - Verifying Employee Deletion
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter Automation UserId in the User Email
	And I Enter Automation Password in the User Password
