Feature: Verification of Employee Devices user

@EmployeeDevices_User_001
Scenario: Employee Devices User - Verifying Employee creation
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter "EmployeeDevicesuser@findd.io" in the User Email
...
@EmployeeDevices_User_002 @EmployeeDevices_Group01
Scenario: Employee Devices User - Verifying Adding Timecard entry
...
@EmployeeDevices_User_003 @EmployeeDevices_Group01
Scenario: Employee Devices User - Verifying Approve Timecard
...
@EmployeeDevices_User_007 @EmployeeDevices_Group01
Scenario: Employee Devices User - Verifying Account Menu is not visible
	When I click on setting option
	Then "Account Menu" should not displayed in "Employee" Page
	
@EmployeeDevices_User_011 @EmployeeDevices_Group01
...
@EmployeeDevices_User_012 @EmployeeDevices_Group01
Scenario: Verify that an editing an existing Timecard is not allowed for an employee with Read Only Permission in Timecard Page
	...
	@EmployeeDevices_User_013 @EmployeeDevices_Group01
...
@EmployeeDevices_User_010 @EmployeeDevices_Group01
Scenario: Employee Devices User - Approve button should not visible in Timecards Page
	When I click on Timecards Menu in Homepage	
	Then Timecards page should displayed
	When I click on "Not Approved" in the Timecards Page
...
@EmployeeDevices_User_005 @EmployeeDevices_Group01
Scenario: Employee Devices User - Verifying Deleting Timecard entry	
	When I wait for 2 seconds
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
	When I Enter the recently used employee in the search box
...
@EmployeeDevices_User_004 @EmployeeDevices_Group01
Scenario: Employee Devices User - Verifying Employee Status Change
	When I wait for 2 seconds
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
	When I Enter the recently used employee in the search box
...
@EmployeeDevices_User_006
Scenario: Employee Devices User - Verifying Unlock Timecard
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter Automation UserId in the User Email
	And I Enter Automation Password in the User Password
	...
	And I click on Logout
	Then Login page should displayed
	#Loging as EmployeeDevices User		
	When I Enter "EmployeeDevicesuser@findd.io" in the User Email
	And I Enter "password" in the User Password
	And I click on Login Button
	Then Home page should displayed
	...
	@EmployeeDevices_User_007
Scenario: Employee Devices User - Verifying Employee Deletion
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter Automation UserId in the User Email
	And I Enter Automation Password in the User Password
