Feature: Verification of Timecard Approver User Permission

@TimecardApprover_User_001
Scenario: Timecard Approver - Verifying Employee creation is not allowed
	Given "Test" URL in the browser
	Then Login page should displayed
	When I Enter "timecardapprover@findd.io" in the User Email
...
@TimecardApprover_User_0041
Scenario: Verify that an add device for an employee is not allowed for an employee with Approve Timecard Permission
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
...
@TimecardApprover_User_0042
Scenario: Verify that an Account menu is not allowed available for an employee with Approve Timecard Permission
	When I click on setting option
	Then "Account Menu" should not displayed in "Employee" Page
	
@TimecardApprover_User_0043
Scenario: Verify that an Adding Timecard is not allowed for an employee with Approve Timecard Permission in Timecard Page
...
@TimecardApprover_User_0045
Scenario: Verify that an editing an existing Timecard is not allowed for an employee with Approve Timecard Permission in Timecard Page
	When I click on "Not Approved" in the Timecards Page
	Then I wait for 5 seconds
	Then "Overtime Hours" should displayed
	And I click on "First Name" button in the Timecards Page	
...
@TimecardApprover_User_0046
Scenario: Verify that a deleting Timecard is not allowed for an employee with Approve Timecard Permission in Timecard Page
	When I click on "Not Approved" in the Timecards Page
	Then I wait for 5 seconds
	Then "Overtime Hours" should displayed
	And I click on "First Name" button in the Timecards Page	
...
@TimecardApprover_User_002
Scenario: Timecard Approver - Verifying Adding Timecard entry is not allowed
...
@TimecardApprover_User_003
Scenario: Timecard Approver - Verifying Approve Timecard is allowed
...
@TimecardApprover_User_004
Scenario: Timecard Approver - Verifying Deleting Timecard entry	is not allowed
...
@TimecardApprover_User_005
Scenario: Timecard Approver - Verifying Employee Status Change is not allowed
	When I wait for 2 seconds
	When I click on Employee Menu in Homepage
	Then Employee page should displayed
	When I click on search button
...
@TimecardApprover_User_006
Scenario: Timecard Approver User - Verifying Unlock Timecard is allowed
	Given URL in the browser
	Then Login page should displayed
	When I Enter Automation UserId in the User Email
	And I Enter Automation Password in the User Password
	...
	@TimecardApprover_User_007
Scenario: Timecard Approver User - Verifying Employee Deletion is not allowed
	Given URL in the browser
	Then Login page should displayed
	When I Enter Automation UserId in the User Email
	And I Enter Automation Password in the User Password
